package uts.bagus.mobile.activity.report

import android.os.Bundle
import android.util.Log.d
import uts.bagus.mobile.R
import uts.bagus.mobile.activity.report.adapter.ReportAdapter
import uts.bagus.mobile.activity.report.detail.DetailReportFragment
import uts.bagus.mobile.activity.report.presenter.ReportPresenter
import uts.bagus.mobile.activity.report.presenter.ReportView
