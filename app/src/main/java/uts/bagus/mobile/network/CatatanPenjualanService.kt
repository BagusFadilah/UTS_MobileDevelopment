package uts.bagus.mobile.network

import uts.bagus.mobile.activity.data_barang.data.ResultDataBarang
import uts.bagus.mobile.activity.login.data.ResultLogin
import uts.bagus.mobile.activity.penjualan.data.ResultKeranjang
import uts.bagus.mobile.activity.penjualan.data.ResultSearchBarang
import uts.bagus.mobile.activity.report.detail.data.ResultItemKeranjang
import uts.bagus.mobile.response.ResultSimple
